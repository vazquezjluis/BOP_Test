<?php
class ConexionBejerman_model extends CI_Model {
    ...
    function get($table,$fields,$where='',$perpage=0,$start=0,$one=false,$array='array'){
        ...
        $this->db->from($table);
        $this->db->order_by('idConexionBejerman','desc');
    ...
    function getById($id){
        $this->db->where('idConexionBejerman',$id);
        $this->db->limit(1);
        return $this->db->get('ConexionBejerman')->row();
    }

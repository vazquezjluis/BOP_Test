...
class Tema extends CI_Controller {
    ...
    function index(){
        $this->data['view'] = 'rrhh/capacitacion/tema/tema';
...
//        {     
            if($this->input->post('nombre')!=''){
                ...
                if ($this->tema_model->add('tema',$data) == TRUE)
                    {   
                        $acciones = array(
                            'usuario' => $this->session->userdata('id'),
                            'accion_id' => 1,
                            'accion' => 'Agrega el tema: '.$this->input->post('nombre'),
                            'modulo' => 2,
                            'fecha_registro' => date('Y-m-d')
                        );
                        if ($this->consola_model->add('consola',$acciones) == TRUE){

                            $this->session->set_flashdata('success','Tema registrado con éxito!');
...
//        }
        ...
        $this->data['view'] = 'rrhh/capacitacion/tema/agregarTema';

            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formArticulo" method="post" class="form-horizontal" >
                     <div class="control-group">
                        <?php echo form_hidden('idArticulo',$result->idArticulo) ?>
                        <label for="nombre" class="control-label">Nombre / Descripcion<span class="required">*</span></label>
                        <div class="controls">
                        ...
                        <div class="controls">
                            <label for="entrada" class="btn btn-default" style="margin-top: 5px;">Entrada 
                                <input type="checkbox" id="entrada" name="entrada" class="badgebox" value="1" 
                                    <?php //echo ($result->entrada == 1)?'checked':''?>>
                                <span class="badge" >&check;</span>
                            </label>
                            <label for="salida" class="btn btn-default" style="margin-top: 5px;">Salída 
                                <input type="checkbox" id="salida" name="salida" class="badgebox" value="1"
                                    <?php //($result->salida == 1)?'checked':''?>>
                                <span class="badge" >&check;</span>
                            </label>
                        </div>
                    </div>-->
...
<!--                    <div class="control-group">
                    ...
                    <div class="controls">
                        <select id="categoria" name="categoria">
                            <option value="1" <?=($result->categoria== '1')?'selected':''?>>Categoria</option>
                        </select>                        
                    </div>
                    </div>     
                    <?php
                    ...
                    ?>
                     <div class="control-group">
                        <label for="categoria" class="control-label">Asociar a un modelo de máquina</label>
                        <div class="controls">
                            <div class="span6">
                                ...
                                <div class="accordion-group widget-box">
                                  <div class="accordion-heading">
                                      <div class="widget-title tipoModelo" data-tipo="modelo">
                                          ...
                                          if(count($modelos_elegidos)==0){ echo "No hay modelos asociados";}else{ echo "Hay ".count($modelos_elegidos)." modelos seleccionados";}?>
                                          </h5>
                                      </div>
                                  </div>
                                </div>

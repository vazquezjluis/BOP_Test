        ...
        <ul class="nav nav-tabs">
            <li class="active">
                <a data-toggle="tab" href="#tab1">
                    Candidato <?php echo $result[0]->nombre." ".$result[0]->apellido; ?>
                </a>
            </li>
        </ul>
    </div>          
        ...
        <table class="table table-bordered " style="background-color: #FFF;">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <i>Si usted no puede ver archivos .doc o .docx, agrege la extencion</i> <label class="alert alert-info"><a href="https://chrome.google.com/webstore/detail/office-editing-for-docs-s/gbkeegbaiigmenfmjfclcdgdpimamgkj?hl=es-419"> haciendo click aquí.</a></label>
...
<div id="modal-cv" class="modal hide fade" style="width: 60%; " tabindex="-1" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div id="modal-psicotecnico" class="modal hide fade" style="width: 60%; " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div id="modal-ambiental" class="modal hide fade" style="width: 60%; " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
<div id="modal-policial" class="modal hide fade" style="width: 60%; " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h5 id="myModalLabel">Ambiental</h5>
  </div>

    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formVinculoPremio" enctype="multipart/form-data" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="premio" id="premio" required="required">
                                <option value="">Seleccione</option>
                                
                                <?php
                                 foreach ($premio as $pre){
                                     echo "<option value='".$pre->idPremio."'  ";
                                     if (set_value('premio')==$pre->idPremio){
                                         echo " selected ";
                                     }
                                     echo ">".$pre->nombre."</option>";
                                 }
                                ?>
                            </select>
                            <a href="<?php echo base_url()?>index.php/premio/agregar" class="btn btn-default btn-mini"><i class="icon-plus icon-white"></i> Agregar nuevo premio</a>
                        </div>
                    </div>

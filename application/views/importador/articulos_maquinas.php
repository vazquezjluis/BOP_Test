        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <div class="span12 well">
                    <div class="span12"><h3>Importador de Artículos a Máquinas</h3></div>
                    <div class="span8">
                        <h5>Requermientos</h5>
                        ...
                        <p><span class="icon-chevron-right"></span>&nbsp;&nbsp; Los datos deben estar entre las columnas "A" y "C" inclusive.</p>
                        <p><span class="icon-chevron-right"></span>&nbsp;&nbsp; Revise que no existan celdas vacías en las columnas. </p>
                    ...
                    <div class="span3" style="border: 1px solid #ccc;padding: 1%;border-radius: 5px;margin: 1%;">
                        <a href="#modal-excluir"  style="margin-top:0px;float: right;" role="button" data-toggle="modal">
                            ...
                            <img  src="<?php echo  base_url()."assets/img/import_articulos_maquinas.jpg"; ?>" width="100%;"/>
                        </a>
                    </div>
                ...
                <form action="<?php echo current_url(); ?>" id="formArquivo" enctype="multipart/form-data" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input  type="hidden" name="tipo" value="articulos_maquinas"/>

        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <div class="span12 well">
                    <div class="span12"><h3>Importador de máquinas</h3></div>
                    <div class="span8">
                        <h5>Requermientos</h5>
                        ...
                        <p><table border="1" cellpadding="3"><tr><td> Nro. EGM </td> <td>Fabricante </td><td> Modelo </td> <td>% de Pago </td> <td>Denom. </td> <td>Juego </td> <td>Nro. Serie </td><td> Programa </td><td>Credito </td></tr></table></p>
                        <p><span class="icon-chevron-right"></span>&nbsp;&nbsp; Respete los puntos, espacios y mayusculas del encabezado.</p>
                        <p><span class="icon-chevron-right"></span>&nbsp;&nbsp; Los datos deben estar entre las columnas "A" e "I" inclusive.</p>
                        <p><span class="icon-chevron-right"></span>&nbsp;&nbsp; Revise que no existan celdas vacías. </p>
                        <p><span class="icon-chevron-right"></span>&nbsp;&nbsp; El Nro. EGM debe ser numérico de 7 caracteres. </p>
                        <p><span class="icon-chevron-right"></span>&nbsp;&nbsp; El sistema toma los datos de la hoja activa. Es recomendable que el archivo solo tenga una hoja para evitar confusión. </p>
                    </div>
                    <div class="span3" style="border: 1px solid #ccc;padding: 1%;border-radius: 5px;margin: 1%;">
                        <a href="#modal-excluir"  style="margin-top:0px;float: right;" role="button" data-toggle="modal">
                            ...
                            <img  src="<?php echo  base_url()."assets/img/import_maquina.png"; ?>" width="100%;"/>
                        </a>
                    </div>

<?php
class Articulos_maquinas_model extends CI_Model {
    ...
    function get($table,$fields,$where='',$perpage=0,$start=0,$one=false,$array='array'){
        ...
        $this->db->from($table);
        $this->db->order_by('idArticuloMaquina','desc');
    ...
    function getById($id){
        $this->db->where('idArticuloMaquina',$id);
        $this->db->limit(1);
        return $this->db->get('articulos_maquinas')->row();
    }

    ...
    <div class="span12">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <h5>Importacion de articulos</h5>
            </div>
            <div class="widget-content nopadding">
                ...
                if (isset($html) and $html!=''){
                    ...
                    if (count($result)){
                        ...
                        if ($result['distintos'] == 0 and $result['nuevos']==0 ){
...
//                            echo "<h5 style='margin-left:5%;'> Registros que pasaran a 'fuera de servicio' : ".$result['bajas']." </h5>";
                            ...
                            echo '          <table class="table">
                                                <tr>
                                                    ...
                                                    <td><b>stkart_codgen</b></td>
                                                    <td><b>skart_codEle1</b></td>
                                                    <td><b>skart_codEle2</b></td>
                                                    <td><b>skart_codEle3</b></td>
                                                    <td><b>Cantidad</b></td>
                                                    
                                                <tr>';
                                            foreach ($_SESSION['new_import'] as $k=>$v){
                                                $esplota  = explode('#', $v);
                                                $esplota2 = explode('-', $esplota[1]); 
                            echo'               <tr>
                                                    <td>'.$esplota2[0].'</td>
                                                    <td>'.$esplota2[1].'</td>
                                                    <td>'.$esplota2[2].'</td>
...
<div id="modal-importar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <form action="<?php echo base_url() ?>index.php/Importador/importar" method="post" >
        ...
        <div class="modal-body">
          ...
          <p><strong> Si usted hace click en importar, los registros de los articulos seran actualizados y no podran ser recuperados. </strong></p>
